 ...
 * @author Saswata
 */
public class ImageOptimizerServlet2 extends HttpServlet {
               ...
               throws ServletException, java.io.IOException
    {
       ...
       try{ 
            ...
            BufferedImage watermarkImage = ImageIO.read(new URL("http://localhost:8080/findSpace.png"));
...
/*
                ...
                //Watermark
                addImageWatermark(watermarkImage, new File(newFile), new File(newFile), per);*/
            }
    ...
    //Watermark
    private void addImageWatermark(BufferedImage watermarkImage, File sourceImageFile, File destImageFile, float per)
    {
        try
        {
